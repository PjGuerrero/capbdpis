...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Flood Video Upload</h1>        
    </div>
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Flood Video Upload </h6>
    <div class="border-bottom my-3"></div>
  ...
  <div class="card-body">
    ...
    <div class="table-responsive">
      <form class="form-horizontal" method="post" action="<?= base_url('vgfupload')?>" enctype="multipart/form-data" >
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a class="btn btn-danger" id="myWish" href="<?= base_url('deletevgf'.$row['id'])?>">Delete</a>
  ...
  <div class="modal fade" id="newForm" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" action="<?= base_url('vgfupload')?>" class="form" enctype="multipart/form-data">
            <div class="form-row align-items-center">
              <label class="form-label" for="customFile">Select Video</label>
              <input type="file" name="video" accept=".mp4, .avi, .flv, .3gp, .mkv" class="form-control" id="customFile" required/>
            </div>
  ...
  <div class="modal fade" id="editModal<?= $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" action="<?= base_url('vgfedit'.$row['id'])?>" class="form" enctype="multipart/form-data">
            <div class="form-row align-items-center">
